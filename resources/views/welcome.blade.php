...
<form action="/stats" method="post">
  ...
  <div class="container">
    ...
    <div class="input-group-prepend">
      <input class="no-opacity" id="radio-windows" type="radio" name="platform" value="pc">
      ...
      <input class="no-opacity" id="radio-xbox" type="radio" name="platform" value="xb1">
      ...
      <input class="no-opacity" id="radio-psn" type="radio" name="platform" value="ps4">
